        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    @elseif ($active == 'Detail Riwayat Transaksi')
                        @include('guest.profile.transaction_details')
                    @endif
                    ...
                    <div class="card w-100">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><a href="{{ route('transaction-history') }}"
                                    class="btn btn-hover-green w-100 text-left {{ $active == 'Riwayat Transaksi' || $active == 'Detail Riwayat Transaksi' ? 'active' : '' }}">Riwayat
                                    Transaksi</a>
                            </li>
                        </ul>
                    </div>
