                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control mb-0 @error('address') is-invalid @enderror" name="address"
                                id="address" rows="3"
                        ...
                        <div class="checkout__order">
                            ...
                            <ul>
                                ...
                                <li>{{$s->product->product_name ." x ".$s->qty}} <span>
                                        {{($s->product->discount>0)? currencyIDR(($s->product->price -
                                        ($s->product->price * $s->product->discount)
                                        / 100)) * $s->qty : currencyIDR($s->product->price * $s->qty)}}</span></li>
                                @endforeach
                            </ul>
